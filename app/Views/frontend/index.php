...
<section class="hero-section">
    <div class="container">
        <div class="hs-slider owl-carousel">
            <div class="hs-item set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/hero/hero-1.jpg">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hc-inner-text">
                            <div class="hc-text">
                                <h4>Peters Brown</h4>
                                <p><span class="icon_pin_alt"></span> Ogba, Lagos Nigeria</p>
                                <div class="label">For Rent</div>
                                <h5>&#8358; 950,000<span>/Yearly</span></h5>
                            </div>
                            <div class="hc-widget">
                                <ul>
            ...
            <div class="hs-item set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/hero/hero-2.jpeg">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hc-inner-text">
                            <div class="hc-text">
                                <h4>Mr Michael Okire</h4>
                                <p><span class="icon_pin_alt"></span> Oshafa, Abuja (FCT)</p>
                                <div class="label">For Rent</div>
                                <h5>&#8358; 230,000<span>/Yearly</span></h5>
                            </div>
                            <div class="hc-widget">
                                <ul>
                                    <li><i class="fa fa-object-group"></i> 2, 283</li>
            ...
            <div class="hs-item set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/hero/hero-3.jpg">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hc-inner-text">
                            <div class="hc-text">
                                <h4>Mr Henry Sulian</h4>
                                <p><span class="icon_pin_alt"></span> Makata, Abuja (FCT)</p>
                                <div class="label">For Sale</div>
                                <h5>&#8358; 240,000,000<span></span></h5>
                            </div>
                            <div class="hc-widget">
                                <ul>
                                    <li><i class="fa fa-object-group"></i> 2, 283</li>
    ...
    <div class="container">
        ...
        <div class="search-form-content">
            <form action="#" class="filter-form">
                ...
                <select class="sm-width" required>
                    <option value="">Property Type</option>
                    <?php if(isset($p_type)){
                            foreach ($p_type as $pcat){?> <option value="<?php echo $pcat->id ; ?>"><?php echo $pcat->ptype ; ?></option>
                            <?php }} ?>
                </select>
                <select class="sm-width">
        ...
        <div class="row property-filter">
            <div class="col-lg-4 col-md-6 mix all house">
                <div class="property-item">
                    <div class="pi-pic set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/property/property-1.jpg">
                        <div class="label">For rent</div>
                    </div>
                    <div class="pi-text">
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                        <div class="pt-price">&#8358; 2,500,000<span>/Yearly</span></div>
                        ...
                        <div class="pi-agent">
                            <div class="pa-item">
                                <div class="pa-info">
                                    <img src="<?php echo BASEURL; ?>assets/img/property/posted-by/pb-1.jpg" alt="">
            ...
            <div class="col-lg-4 col-md-6 mix all restaurent hotel">
                <div class="property-item">
                    <div class="pi-pic set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/property/property-2.jpg">
                        <div class="label c-red">For rent</div>
                    </div>
                    <div class="pi-text">
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                        <div class="pt-price">&#8358; 2,000,000</div>
            ...
            <div class="col-lg-4 col-md-6 mix all apart office">
                <div class="property-item">
                    ...
                    <div class="pi-text">
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                        <div class="pt-price">&#8358; 250,000</div>
            ...
            <div class="col-lg-4 col-md-6 mix all hotel restaruent">
                <div class="property-item">
                    <div class="pi-pic set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/property/property-4.jpg">
                        <div class="label c-red">For rent</div>
                    </div>
                    <div class="pi-text">
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                        <div class="pt-price">&#8358; 850,000</div>
            ...
            <div class="col-lg-4 col-md-6 mix all office hotel">
                <div class="property-item">
                    <div class="pi-pic set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/property/property-5.jpg">
                        <div class="label c-magenta">For rent</div>
                    </div>
                    <div class="pi-text">
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                        <div class="pt-price">&#8358; 1,500,000</div>
            ...
            <div class="col-lg-4 col-md-6 mix house apart office">
                <div class="property-item">
                    <div class="pi-pic set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/property/property-6.jpg">
                        <div class="label">For rent</div>
                    </div>
                    <div class="pi-text">
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                        <div class="pt-price">&#8358; 450,000<span>/Yearly</span></div>
...
<section class="chooseus-section spad set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/chooseus/chooseus-bg.jpg">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="chooseus-features">
                    <div class="cf-item">
                        <div class="cf-pic">
                            <img src="<?php echo BASEURL; ?>assets/img/chooseus/chooseus-icon-1.png" alt="">
                        </div>
                        <div class="cf-text">
                    ...
                    <div class="cf-item">
                        <div class="cf-pic">
                            <img src="<?php echo BASEURL; ?>assets/img/chooseus/chooseus-icon-2.png" alt="">
                        </div>
                        <div class="cf-text">
                    ...
                    <div class="cf-item">
                        <div class="cf-pic">
                            <img src="<?php echo BASEURL; ?>assets/img/chooseus/chooseus-icon-3.png" alt="">
                        </div>
                        <div class="cf-text">
                    ...
                    <div class="cf-item">
                        <div class="cf-pic">
                            <img src="<?php echo BASEURL; ?>assets/img/chooseus/chooseus-icon-4.png" alt="">
                        </div>
                        <div class="cf-text">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 p-0">
                <div class="fp-slider owl-carousel">
                    <div class="fp-item set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/feature-property/fp-1.jpg">
                        <div class="fp-text">
                    ...
                    <div class="fp-item set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/feature-property/fp-2.jpg">
                        <div class="fp-text">
                            <h5 class="title">Home in Merrick Way</h5>
                            <p><span class="icon_pin_alt"></span> 3 Middle Winchendon Rd, Rindge, NH 03461</p>
                            <div class="label">For Rent</div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="ts-item">
                    <div class="ts-text">
                        <img src="<?php echo BASEURL; ?>assets/img/team/team-1.jpg" alt="">
            ...
            <div class="col-md-4">
                <div class="ts-item">
                    <div class="ts-text">
                        <img src="<?php echo BASEURL; ?>assets/img/team/team-2.jpg" alt="">
                        <h5>Ashton Kutcher</h5>
                        <span>123-455-688</span>
                        <p>Ipsum dolor amet, consectetur adipiscing elit, eiusmod tempor incididunt lorem.</p>
                        <div class="ts-social">
            ...
            <div class="col-md-4">
                <div class="ts-item">
                    <div class="ts-text">
                        <img src="<?php echo BASEURL; ?>assets/img/team/team-3.jpg" alt="">
                        <h5>Ashton Kutcher</h5>
                        <span>123-455-688</span>
                        <p>Ipsum dolor amet, consectetur adipiscing elit, eiusmod tempor incididunt lorem.</p>
                        <div class="ts-social">
...
<section class="categories-section">
    <div class="cs-item-list">
        <div class="cs-item set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/categories/cat-1.jpg">
            <div class="cs-text">
                <h5>Apartment</h5>
                <span>230 property</span>
            </div>
        </div>
        <div class="cs-item set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/categories/cat-2.jpg">
            <div class="cs-text">
                <h5>Villa</h5>
                <span>230 property</span>
            </div>
        </div>
        <div class="cs-item set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/categories/cat-3.jpg">
            <div class="cs-text">
                <h5>House</h5>
                <span>230 property</span>
            </div>
        </div>
        <div class="cs-item set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/categories/cat-4.jpg">
            <div class="cs-text">
                <h5>Restaurent</h5>
                <span>230 property</span>
            </div>
        </div>
        <div class="cs-item set-bg" data-setbg="<?php echo BASEURL; ?>assets/img/categories/cat-5.jpg">
            <div class="cs-text">
                <h5>Office</h5>
                <span>230 property</span>
            </div>
        ...
        <div class="row testimonial-slider owl-carousel">
            <div class="col-lg-6">
                <div class="testimonial-item">
                    <div class="ti-text">
                        <p>Have you ever under the stress in acquring property ,Rent Flexy is the solution .</p>
                    </div>
                    <div class="ti-author">
                        <div class="ta-pic">
                            <img src="<?php echo BASEURL; ?>assets/img/testimonial-author/ta-1.jpg" alt="">
                        </div>
                        <div class="ta-text">
                            <h5>Samuel Okafor</h5>
            ...
            <div class="col-lg-6">
                <div class="testimonial-item">
                    <div class="ti-text">
                        <p>Rent Flexy is the best Renting provider in Nigeria ,check out to know more.</p>
                    </div>
                    <div class="ti-author">
                        <div class="ta-pic">
                            <img src="<?php echo BASEURL; ?>assets/img/testimonial-author/ta-2.jpg" alt="">
                        </div>
                        <div class="ta-text">
                            <h5>Mike William</h5>
                            <span>Client</span>
            ...
            <div class="col-lg-6">
                <div class="testimonial-item">
                    <div class="ti-text">
                        <p>Right plug for housing issue ,sign up today .</p>
                    </div>
                    <div class="ti-author">
                        <div class="ta-pic">
                            <img src="<?php echo BASEURL; ?>assets/img/testimonial-author/ta-1.jpg" alt="">
        ...
        <div class="lc-slider owl-carousel">
            <a href="#" class="lc-item">
                <div class="lc-item-inner">
                    <img src="<?php echo BASEURL; ?>assets/img/logo-carousel/lc-1.png" alt="">
                </div>
            </a>
            <a href="#" class="lc-item">
                <div class="lc-item-inner">
                    <img src="<?php echo BASEURL; ?>assets/img/logo-carousel/lc-2.png" alt="">
                </div>
            </a>
            <a href="#" class="lc-item">
                <div class="lc-item-inner">
                    <img src="<?php echo BASEURL; ?>assets/img/logo-carousel/lc-3.png" alt="">
                </div>
            </a>
            <a href="#" class="lc-item">
                <div class="lc-item-inner">
                    <img src="<?php echo BASEURL; ?>assets/img/logo-carousel/lc-4.png" alt="">
                </div>
            </a>
            <a href="#" class="lc-item">
                <div class="lc-item-inner">
                    <img src="<?php echo BASEURL; ?>assets/img/logo-carousel/lc-5.png" alt="">
                </div>
            </a>
            <a href="#" class="lc-item">
                <div class="lc-item-inner">
                    <img src="<?php echo BASEURL; ?>assets/img/logo-carousel/lc-6.png" alt="">
                </div>
            </a>
        </div>
    </div>
            ...
            <div class="col-lg-6">
                <div class="contact-info">
                    ...
                    <div class="ci-item">
                        ...
                        <div class="ci-text">
                            <h5>Support</h5>
                            <p>team.support@rentflexy.com</p>
                        </div>
                    </div>
                </div>
            </div>
