        ...
        <div class="as-slider owl-carousel">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="as-item">
                        <div class="as-pic">
                            <img src="<?php echo BASEURL; ?>assets/img/agents/agent-1.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="as-item">
                        <div class="as-pic">
                            <img src="<?php echo BASEURL; ?>assets/img/agents/agent-2.jpg" alt="">
                            <div class="rating-point">
                                4.5
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="as-item">
                        <div class="as-pic">
                            <img src="<?php echo BASEURL; ?>assets/img/agents/agent-3.jpg" alt="">
                            <div class="rating-point">
                                4.5
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="as-item">
                        <div class="as-pic">
                            <img src="<?php echo BASEURL; ?>assets/img/agents/agent-4.jpg" alt="">
                            <div class="rating-point">
                                4.5
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="as-item">
                        <div class="as-pic">
                            <img src="<?php echo BASEURL; ?>assets/img/agents/agent-5.jpg" alt="">
                            <div class="rating-point">
                                4.5
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="as-item">
                        <div class="as-pic">
                            <img src="<?php echo BASEURL; ?>assets/img/agents/agent-6.jpg" alt="">
                            <div class="rating-point">
                                4.5
                            </div>
                        </div>
